...
setup(
    ...
    description='QtFusion is a Python library created by Seasal Wesley (seasalwesley@gmail.com) for the convenient '
                'creation of PySide6 applications that interact with deep learning models. It provides user interface '
                'management and beautification, database management, image/video/camera processing, model interface '
                'definition, and event handling. This makes it easy for users to create deep learning applications.',
    classifiers=[
